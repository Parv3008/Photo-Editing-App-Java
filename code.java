...
4 | P a g e
 ...
 JOptionPane.showMessageDialog(this, "Invalid Image File Selected", "Error", 
JOptionPane.ERROR_MESSAGE);
 ...
 JOptionPane.showMessageDialog(this, "Error Loading The Image", "Error", 
JOptionPane.ERROR_MESSAGE); 
 }
 } 
 }
...
5 | P a g e
 ...
 ex.printStackTrace();
 // Show an error message if there's an issue loading the image
 JOptionPane.showMessageDialog(this, "Error Saving The Image", "Error", 
JOptionPane.ERROR_MESSAGE); 
 }
 } 
 
 }
 // crate a method that applies a grayscale filter to the edited image using the luminosity method
